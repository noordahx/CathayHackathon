...
const ChartOne: React.FC = () => {
    const [state, setState] = useState<ChartOneState>({
        series: [
            {
                name: "2022",
                data: [25, 19, 26, 22, 26, 24, 23, 22, 19, 28, 28, 29],
            },

            {
                name: "2023",
                data: [11, 11, 13, 14, 14, 10, 11, 11, 15, 12],
            },
        ],
    });
            ...
            <span
              ...
              <span className="block h-2.5 w-full max-w-2.5 rounded-full bg-primary"></span>
                        ...
                        <div className="w-full">
                            <p className="font-semibold text-primary">Avg monthly anomalies last year</p>
                            <p className="text-sm font-medium">01.01.2022 - 31.12.2022</p>
                        </div>
                    </div>
                    <div className="flex min-w-47.5">
            <span
              ...
              <span className="block h-2.5 w-full max-w-2.5 rounded-full bg-secondary"></span>
                        ...
                        <div className="w-full">
                            <p className="font-semibold text-secondary">Avg monthly anomalies current year</p>
                            <p className="text-sm font-medium">01.01.2023 - 19.11.2023</p>
                        </div>
                    </div>
                </div>
