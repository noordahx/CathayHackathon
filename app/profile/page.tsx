        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
              As a dedicated employee of Cathay, I am proud to be a part of the Cargo Division, contributing to the efficient and seamless operations of one of the leading airlines. With a strong commitment to excellence and customer satisfaction, I strive to deliver exceptional service in the field of cargo management.

With extensive knowledge and expertise in handling cargo logistics, I am well-versed in coordinating the safe and timely transportation of goods across various destinations. From managing complex logistics networks to ensuring compliance with industry regulations, I work diligently to ensure the smooth flow of cargo operations.
              </p>
            </div>
